...
public class OnlinePreviewController {
    ...
    public String onlinePreview(String url, Model model, HttpServletRequest req) {
        AtomicReference<FileAttribute> fileAttribute = new AtomicReference<>(fileUtils.getFileAttribute(url));
        req.setAttribute("fileKey", req.getParameter("fileKey"));
        model.addAttribute("officePreviewType", req.getParameter("officePreviewType"));
        FilePreview filePreview = previewFactory.get(fileAttribute.get());
        return filePreview.filePreviewHandle(url, model, fileAttribute.get());
    }
